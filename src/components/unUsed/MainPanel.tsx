...
//           <div
//             className="relative mx-10 mt-5 h-[400px] w-[400px] "
//             style={{ backgroundColor: `${baseColor}` }}
//           >
//             {secondColor ? (
//               <SampleDesign width={400} height={400} secondColor={`${secondColor}`} />
//             ) : (
...
//           <div
//             className="relative mx-10 mt-5 h-[400px] w-[400px] border-[1px]"
//             style={{ backgroundColor: `${baseColor}` }}
//           >
...
//           pattern:{pattern} / baseColor:{baseColor} / secondColor:{secondColor}
//         </p>
//       </div>
//     </>
//   );

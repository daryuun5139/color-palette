...
import { randomColorState_Yellow } from "@/lib/atoms/random-color-state";
// レイアウト系インポート
import { ScrollArea, ScrollBar } from "@/components/ui/scroll-area";
// その他インポート
import { baseYellowPalettes } from "@/lib/colorData/colorPalettes";
            ...
            <div key={`${colorName}-palette-${paletteIndex + 1}`}>
              ...
              <div>
                ...
                <ScrollArea className="w-[60%] whitespace-nowrap">
                  ...
                  {randomColorListYellow[paletteIndex] ? (
                    <SetPatternAndColor
                      palette={palette}
                      ...
                      pattern={pattern}
                      colorName={colorName}
                      randomColorList={randomColorListYellow}
...
export default YellowColorsList;
